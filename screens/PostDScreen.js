...
export default class PostDScreen extends React.Component {
...
{/* <Image source={require("../assets/tempAvatar.jpg")} style={styles.avatar}></Image> */}
                ...
                <View style={styles.inputContainer}>
                    <Text style={styles.inputTitle}>Alamat Asal</Text>
                    <TextInput
                        autoFocus={true}
                        //multiline={true}
                        //numberOfLines={4}
          ...
          onValueChange={(jk) => this.setState({jk: jk})}>
          <Picker.Item label="pria" value="l" />
          <Picker.Item label="wanita" value="p" />
        </Picker>

                </View>
                <View style={styles.inputContainer}>
{/* <Image source={require("../assets/tempAvatar.jpg")} style={styles.avatar}></Image> */}
                    <Text style={styles.inputTitle}>Umur</Text>
                    <TextInput
                        autoFocus={true}
                        //multiline={true}
                        //numberOfLines={4}
                ...
                <View style={styles.inputContainer}>
{/* <Image source={require("../assets/tempAvatar.jpg")} style={styles.avatar}></Image> */}
                    <Text style={styles.inputTitle}>Lokasi Hilang</Text>
                    <TextInput
                        autoFocus={true}
                        //multiline={true}
                        //numberOfLines={4}
                ...
                <View style={styles.inputContainer}>
{/* <Image source={require("../assets/tempAvatar.jpg")} style={styles.avatar}></Image> */}
                    <Text style={styles.inputTitle}>Kronologi</Text>
                    <TextInput
                        autoFocus={true}
                        multiline={true}
                        numberOfLines={4}
                        style={styles.input}
                        placeholder="..."
                        onChangeText={kronologi=> this.setState({ kronologi })}
                        value={this.state.kronologi}
                    ></TextInput>
                </View>
